...
Contributors: exclusiveaddons, timstrifler, madjennsy, mmaumio
...
6. Plugin Main Dashboard tab 
7. Dashboard section for enabling/disabling elements

== Changelog ==
= 1.5.9.2 - 30/10/2024 =
- Fix: Crash issue with latest Elementor Pro

= 1.5.9 - 20/03/2024 =
- Enhancement: Fallback to Slick font if Elementor icons font is not available

= 1.5.8 - 17/11/2023 =
- Increase support for Elementor and Elementor Pro

= 1.5.7 - 02/10/2023 =
- Support Cross Site Copy Paste in Elementor container

= 1.5.6 - 23/09/2023 =
- Fix: Critical error in Post Carousel widget
- New "Show Decimals" setting in Chart widget
- Support Elementor 3.16.4 & Elementor Pro 3.16.2

= 1.5.5 - 21/09/2023 =
- Enable AJAX autocomplete for Exclude fields in Post Carousel widget
- Fix RTL issues with Sliders
...
- Fix: Post Carousel and Post Slider issue. 
- Tweak: Overall Bug fixes and improvements.

= 1.5.2 - 21/03/2023 =
- Fix: Gravity Form Widget issue.
- Tweak: Overall Bug fixes and improvements.

...
class Admin_Helper {
	...
	public function insert_action_links( $links ) {
        ...
        if( 'expired' === $license_status ) {
            ...
            $link = Helper_Functions::get_campaign_link( 'https://my.leap13.com/', 'plugins-page', 'wp-dash', 'renew-pro' );

            $pro_link = sprintf( '<a href="%s" target="_blank" style="color: #FF6000; font-weight: bold;">%s</a>', $link, __( 'Renew Now', 'premium-addons-pro' ) );

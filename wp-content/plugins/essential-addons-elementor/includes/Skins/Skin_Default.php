...
class Skin_Default extends Skin_Base
{
    ...
    public function section_style_top_level_item(Widget_Base $widget)
    {
        ...
        $this->add_control(
            'eael_advanced_menu_item_indicator_heading_1',
            [
        ...
        $this->add_control(
            'eael_advanced_menu_item_indicator_note_1',
            [
    ...
    public function section_style_dropdown_item(Widget_Base $widget)
    {
        ...
        $this->add_control(
            'eael_advanced_menu_dropdown_item_indicator_heading_2',
            [
                'label' => __('Dropdown Indicator', 'essential-addons-elementor'),
                'type' => Controls_Manager::HEADING,
        ...
        $this->add_control(
            'eael_advanced_menu_dropdown_item_indicator_note_2',
            [
                'label' => __('Important Note', 'essential-addons-elementor'),
                'show_label' => false,
                'type' => Controls_Manager::RAW_HTML,
